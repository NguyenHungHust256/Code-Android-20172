package com.example.bahung.vtask1.controller.dialogfragment;
...
public class CreateProjectDialog extends DialogFragment{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        alertDialogBuilder.setView(view).setTitle(title).setPositiveButton("Tạo mới",  new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                // on success
                Toast.makeText(getContext(), "Tạo mới", Toast.LENGTH_SHORT).show();
    ...
    public void onAttach(Context context) {
        ...
        try {
            createProject = (CreateProject) getTargetFragment();
