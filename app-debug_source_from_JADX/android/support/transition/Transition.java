...
public abstract class Transition implements Cloneable {
    ...
    private static final PathMotion STRAIGHT_PATH_MOTION = new C03381();
    ...
    class C00803 extends AnimatorListenerAdapter {
        C00803() {
        }
    ...
    static class C03381 extends PathMotion {
        C03381() {
        }
    ...
    protected void animate(Animator animator) {
        ...
        animator.addListener(new C00803());
        animator.start();
    }
