...
class ViewUtilsApi14 implements ViewUtilsImpl {
    ...
    public void setTransitionAlpha(@NonNull View view, float alpha) {
        Float savedAlpha = (Float) view.getTag(C0078R.id.save_non_transition_alpha);
        if (savedAlpha != null) {
    ...
    public void saveNonTransitionAlpha(@NonNull View view) {
        if (view.getTag(C0078R.id.save_non_transition_alpha) == null) {
            view.setTag(C0078R.id.save_non_transition_alpha, Float.valueOf(view.getAlpha()));
        }
    }

    public void clearNonTransitionAlpha(@NonNull View view) {
        if (view.getVisibility() == 0) {
            view.setTag(C0078R.id.save_non_transition_alpha, null);
        }
    }
