...
class ViewGroupUtilsApi14 implements ViewGroupUtilsImpl {
    ...
    class C00821 extends LayoutTransition {
        C00821() {
        }
    ...
    public void suppressLayout(@NonNull ViewGroup group, boolean suppress) {
        if (sEmptyLayoutTransition == null) {
            sEmptyLayoutTransition = new C00821();
        ...
        if (suppress) {
            ...
            if (layoutTransition != null) {
                ...
                if (layoutTransition != sEmptyLayoutTransition) {
                    group.setTag(C0078R.id.transition_layout_save, layoutTransition);
                }
            }
        ...
        layoutTransition = (LayoutTransition) group.getTag(C0078R.id.transition_layout_save);
        if (layoutTransition != null) {
            group.setTag(C0078R.id.transition_layout_save, null);
