...
class GhostViewApi14 extends View implements GhostViewImpl {
    ...
    private final OnPreDrawListener mOnPreDrawListener = new C00741();
    int mReferences;
    ViewGroup mStartParent;
    View mStartView;
    final View mView;

    class C00741 implements OnPreDrawListener {
        C00741() {
        }
    ...
    private static void setGhostView(@NonNull View view, GhostViewApi14 ghostView) {
        view.setTag(C0078R.id.ghost_view, ghostView);
    }

    static GhostViewApi14 getGhostView(@NonNull View view) {
        return (GhostViewApi14) view.getTag(C0078R.id.ghost_view);
    }
}
