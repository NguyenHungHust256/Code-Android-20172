...
public class ChangeImageTransform extends Transition {
    ...
    private static final TypeEvaluator<Matrix> NULL_MATRIX_EVALUATOR = new C00681();
    ...
    static class C00681 implements TypeEvaluator<Matrix> {
        C00681() {
        }
    ...
    private static Matrix copyImageMatrix(ImageView view) {
        switch (C00703.$SwitchMap$android$widget$ImageView$ScaleType[view.getScaleType().ordinal()]) {
            case 1:
