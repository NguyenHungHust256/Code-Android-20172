...
class TranslationAnimationCreator {
    ...
    private static class TransitionPositionListener extends AnimatorListenerAdapter {
        ...
        private TransitionPositionListener(View movingView, View viewInHierarchy, int startX, int startY, float terminalX, float terminalY) {
            ...
            this.mTransitionPosition = (int[]) this.mViewInHierarchy.getTag(C0078R.id.transition_position);
            if (this.mTransitionPosition != null) {
                this.mViewInHierarchy.setTag(C0078R.id.transition_position, null);
            }
        }
        ...
        public void onAnimationCancel(Animator animation) {
            ...
            this.mViewInHierarchy.setTag(C0078R.id.transition_position, this.mTransitionPosition);
        }
    ...
    static Animator createAnimation(View view, TransitionValues values, int viewPosX, int viewPosY, float startX, float startY, float endX, float endY, TimeInterpolator interpolator) {
        ...
        int[] startPosition = (int[]) values.view.getTag(C0078R.id.transition_position);
