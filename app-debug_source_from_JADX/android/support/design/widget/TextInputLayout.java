    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.mErrorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                if (useDefaultColor) {
                    TextViewCompat.setTextAppearance(this.mErrorView, C0241R.style.TextAppearance_AppCompat_Caption);
                    this.mErrorView.setTextColor(ContextCompat.getColor(getContext(), C0241R.color.error_color_material));
                }
        ...
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                try {
                    ...
                    TextViewCompat.setTextAppearance(this.mCounterView, C0241R.style.TextAppearance_AppCompat_Caption);
                    this.mCounterView.setTextColor(ContextCompat.getColor(getContext(), C0241R.color.error_color_material));
                }
