...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    final Callback mManagerCallback = new C03243();
    ...
    class C03232 implements OnApplyWindowInsetsListener {
        C03232() {
        }
    ...
    class C03243 implements Callback {
        C03243() {
        }
    ...
    class C03254 implements OnDismissListener {
        C03254() {
        }
    ...
    class C03265 implements OnAttachStateChangeListener {
    ...
    class C03276 implements OnLayoutChangeListener {
        C03276() {
        }
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content, @NonNull ContentViewCallback contentViewCallback) {
        if (parent == null) {
            ...
            ViewCompat.setOnApplyWindowInsetsListener(this.mView, new C03232());
    ...
    final void showView() {
        if (this.mView.getParent() == null) {
            ...
            if (lp instanceof CoordinatorLayout.LayoutParams) {
                ...
                behavior.setListener(new C03254());
                clp.setBehavior(behavior);
                clp.insetEdge = 80;
            }
            this.mTargetParent.addView(this.mView);
        }
        this.mView.setOnAttachStateChangeListener(new C03265());
        if (!ViewCompat.isLaidOut(this.mView)) {
            this.mView.setOnLayoutChangeListener(new C03276());
