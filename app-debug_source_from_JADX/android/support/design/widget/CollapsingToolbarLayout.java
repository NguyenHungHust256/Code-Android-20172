...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C03331 implements OnApplyWindowInsetsListener {
        C03331() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mCollapsingTextHelper.setCollapsedTextAppearance(C0241R.style.TextAppearance_AppCompat_Widget_ActionBar_Title);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03331());
    }
