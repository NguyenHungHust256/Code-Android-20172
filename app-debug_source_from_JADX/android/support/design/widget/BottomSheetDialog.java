...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C03302 extends AccessibilityDelegateCompat {
        C03302() {
        }
    ...
    class C03314 extends BottomSheetCallback {
        C03314() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C03314();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        ...
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C03302());
