...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C01132();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C01121();
    ...
    class C01132 implements OnItemClickListener {
        C01132() {
        }
