...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C01151();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C03452();

    static class C01151 implements ThreadFactory {
    ...
    class C03452 extends WorkerRunnable<Params, Result> {
        C03452() {
        }
