...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C02241();
    ...
    private final Runnable mSetIdleRunnable = new C02252();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    static class C02241 implements Interpolator {
        C02241() {
        }
