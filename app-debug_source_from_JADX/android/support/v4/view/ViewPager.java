...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01971();
    ...
    private static final Interpolator sInterpolator = new C01982();
    ...
    private final Runnable mEndScrollRunnable = new C01993();
    ...
    static class C01971 implements Comparator<ItemInfo> {
        C01971() {
        }
    ...
    class C03654 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C02001 implements ClassLoaderCreator<SavedState> {
            C02001() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03654());
    }
