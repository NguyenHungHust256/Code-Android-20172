...
class TypefaceCompatBaseImpl implements TypefaceCompatImpl {
    ...
    class C03461 implements StyleExtractor<FontInfo> {
        C03461() {
        }
    ...
    class C03472 implements StyleExtractor<FontFileResourceEntry> {
        C03472() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fonts, int style) {
        return (FontInfo) findBestFont(fonts, style, new C03461());
    }
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry entry, int style) {
        return (FontFileResourceEntry) findBestFont(entry.getEntries(), style, new C03472());
    }
