...
public abstract class VolumeProviderCompat {
    ...
    class C03561 implements Delegate {
        C03561() {
        }
    ...
    public Object getVolumeProvider() {
        if (this.mVolumeProviderObj == null && VERSION.SDK_INT >= 21) {
            this.mVolumeProviderObj = VolumeProviderCompatApi21.createVolumeProvider(this.mControlType, this.mMaxVolume, this.mCurrentVolume, new C03561());
        }
