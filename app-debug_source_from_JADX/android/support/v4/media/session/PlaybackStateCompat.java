...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01611();
    ...
    static class C01611 implements Creator<PlaybackStateCompat> {
        C01611() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01621();
        ...
        static class C01621 implements Creator<CustomAction> {
            C01621() {
            }
