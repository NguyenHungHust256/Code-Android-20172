...
public class MediaSessionCompat {
    ...
    public static final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new C01571();
        public static final int UNKNOWN_ID = -1;
        private final MediaDescriptionCompat mDescription;
        private final long mId;
        private Object mItem;

        static class C01571 implements Creator<QueueItem> {
            C01571() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new C01581();
        private ResultReceiver mResultReceiver;

        static class C01581 implements Creator<ResultReceiverWrapper> {
            C01581() {
            }
    ...
    public static final class Token implements Parcelable {
        public static final Creator<Token> CREATOR = new C01591();
        private final IMediaSession mExtraBinder;
        private final Object mInner;

        static class C01591 implements Creator<Token> {
            C01591() {
            }
    ...
    class C03571 extends Callback {
        C03571() {
        }
    }

    class C03582 extends Callback {
        C03582() {
        }
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C03591();
        ...
        class C03591 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C03591() {
            }
    ...
    static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        class C01551 implements OnPlaybackPositionUpdateListener {
            C01551() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setPlaybackPositionUpdateListener(new C01551());
        }
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        class C01561 implements OnMetadataUpdateListener {
            C01561() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setMetadataUpdateListener(new C01561());
        }
