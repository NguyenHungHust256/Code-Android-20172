...
public class AsyncListUtil<T> {
    ...
    private final BackgroundCallback<T> mBackgroundCallback = new C03772();
    final BackgroundCallback<T> mBackgroundProxy;
    final DataCallback<T> mDataCallback;
    int mDisplayedGeneration = 0;
    int mItemCount = 0;
    private final MainThreadCallback<T> mMainThreadCallback = new C03761();
    ...
    class C03761 implements MainThreadCallback<T> {
        C03761() {
        }
    ...
    class C03772 implements BackgroundCallback<T> {
