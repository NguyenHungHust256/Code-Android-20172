    ...
    public MainThreadCallback<T> getMainThreadProxy(final MainThreadCallback<T> callback) {
        return new MainThreadCallback<T>() {
            ...
            class C02441 implements Runnable {
                ...
                public void run() {
                    SyncQueueItem msg = C03791.this.mQueue.next();
                    while (msg != null) {
                        switch (msg.what) {
                            case 1:
    ...
    public BackgroundCallback<T> getBackgroundProxy(final BackgroundCallback<T> callback) {
        return new BackgroundCallback<T>() {
            ...
            class C02451 implements Runnable {
                ...
                public void run() {
                    while (true) {
                        SyncQueueItem msg = C03802.this.mQueue.next();
                        if (msg != null) {
                            switch (msg.what) {
                                case 1:
                                    C03802.this.mQueue.removeMessages(1);
                                    callback.refresh(msg.arg1);
                                    break;
                                case 2:
                                    C03802.this.mQueue.removeMessages(2);
                                    C03802.this.mQueue.removeMessages(3);
                        ...
                        C03802.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
