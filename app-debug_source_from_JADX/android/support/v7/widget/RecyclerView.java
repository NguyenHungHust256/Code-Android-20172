...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C03951();
        ...
        private final Callback mVerticalBoundCheckCallback = new C03962();
        private int mWidth;
        ...
        class C03951 implements Callback {
            C03951() {
            }
        ...
        class C03962 implements Callback {
            C03962() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0242R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0242R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0242R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0242R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0242R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    class C03924 implements ProcessCallback {
        C03924() {
        }
    ...
    class C03935 implements Callback {
        C03935() {
        }
    ...
    class C03946 implements Callback {
        C03946() {
        }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mViewInfoProcessCallback = new C03924();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0242R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0242R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0242R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = a.getBoolean(C0242R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a.getDrawable(C0242R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a.getDrawable(C0242R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a.getDrawable(C0242R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a.getDrawable(C0242R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C03935());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C03946());
    }
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        FastScroller fastScroller = new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0242R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0242R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0242R.dimen.fastscroll_margin));
    }
