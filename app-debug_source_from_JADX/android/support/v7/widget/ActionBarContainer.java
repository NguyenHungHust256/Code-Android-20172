...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0241R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C0241R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C0241R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C0241R.styleable.ActionBar_height, -1);
        if (getId() == C0241R.id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C0241R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        if (this.mIsSplit) {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0241R.id.action_bar);
        this.mContextView = findViewById(C0241R.id.action_context_bar);
    }
