...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0241R.attr.actionBarSize, 16842841};
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0241R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0241R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0241R.id.action_bar));
        }
    }
