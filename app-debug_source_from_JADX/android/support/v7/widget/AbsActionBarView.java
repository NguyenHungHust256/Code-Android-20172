...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!context.getTheme().resolveAttribute(C0241R.attr.actionBarPopupTheme, tv, true) || tv.resourceId == 0) {
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C0241R.styleable.ActionBar, C0241R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C0241R.styleable.ActionBar_height, 0));
        a.recycle();
