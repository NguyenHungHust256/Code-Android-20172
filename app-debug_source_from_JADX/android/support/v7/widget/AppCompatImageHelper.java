...
public class AppCompatImageHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attrs, C0241R.styleable.AppCompatImageView, defStyleAttr, 0);
        try {
            Drawable drawable = this.mView.getDrawable();
            if (drawable == null) {
                int id = a.getResourceId(C0241R.styleable.AppCompatImageView_srcCompat, -1);
                if (id != -1) {
            ...
            if (a.hasValue(C0241R.styleable.AppCompatImageView_tint)) {
                ImageViewCompat.setImageTintList(this.mView, a.getColorStateList(C0241R.styleable.AppCompatImageView_tint));
            }
            if (a.hasValue(C0241R.styleable.AppCompatImageView_tintMode)) {
                ImageViewCompat.setImageTintMode(this.mView, DrawableUtils.parseTintMode(a.getInt(C0241R.styleable.AppCompatImageView_tintMode, -1), null));
            }
            a.recycle();
        } catch (Throwable th) {
            a.recycle();
