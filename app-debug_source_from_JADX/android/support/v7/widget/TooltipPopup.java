...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(C0241R.layout.tooltip, null);
        this.mMessageView = (TextView) this.mContentView.findViewById(C0241R.id.message);
        ...
        this.mLayoutParams.windowAnimations = C0241R.style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View anchorView, int anchorX, int anchorY, boolean fromTouch, LayoutParams outParams) {
        ...
        int offsetBelow;
        int offsetAbove;
        int tooltipPreciseAnchorThreshold = this.mContext.getResources().getDimensionPixelOffset(C0241R.dimen.tooltip_precise_anchor_threshold);
        ...
        if (anchorView.getHeight() >= tooltipPreciseAnchorThreshold) {
            int offsetExtra = this.mContext.getResources().getDimensionPixelOffset(C0241R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        int tooltipOffset = this.mContext.getResources().getDimensionPixelOffset(fromTouch ? C0241R.dimen.tooltip_y_offset_touch : C0241R.dimen.tooltip_y_offset_non_touch);
