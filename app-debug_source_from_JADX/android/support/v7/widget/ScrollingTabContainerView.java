...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    private class TabView extends LinearLayoutCompat {
        ...
        public TabView(Context context, Tab tab, boolean forList) {
            super(context, null, C0241R.attr.actionBarTabStyle);
            this.mTab = tab;
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0241R.attr.actionBarTabStyle, 0);
            if (a.hasValue(0)) {
        ...
        public void update() {
            ...
            if (hasText) {
                if (this.mTextView == null) {
                    TextView textView = new AppCompatTextView(getContext(), null, C0241R.attr.actionBarTabTextStyle);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat tabLayout = new LinearLayoutCompat(getContext(), null, C0241R.attr.actionBarTabBarStyle);
    ...
    private Spinner createSpinner() {
        Spinner spinner = new AppCompatSpinner(getContext(), null, C0241R.attr.actionDropDownStyle);
