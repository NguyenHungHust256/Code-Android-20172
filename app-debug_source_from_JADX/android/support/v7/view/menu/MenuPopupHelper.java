...
public class MenuPopupHelper implements MenuHelper {
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menu) {
        this(context, menu, null, false, C0241R.attr.popupMenuStyle, 0);
    }

    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menu, @NonNull View anchorView) {
        this(context, menu, anchorView, false, C0241R.attr.popupMenuStyle, 0);
    }
    ...
    private MenuPopup createPopup() {
        ...
        if (Math.min(displaySize.x, displaySize.y) >= this.mContext.getResources().getDimensionPixelSize(C0241R.dimen.abc_cascading_menus_min_smallest_width)) {
