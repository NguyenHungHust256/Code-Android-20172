...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C04151();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C04162();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C03753();

    class C03753 implements ViewPropertyAnimatorUpdateListener {
        C03753() {
        }
    ...
    class C04151 extends ViewPropertyAnimatorListenerAdapter {
        C04151() {
        }
    ...
    class C04162 extends ViewPropertyAnimatorListenerAdapter {
        C04162() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0241R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0241R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0241R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0241R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0241R.styleable.ActionBar, C0241R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0241R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0241R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0241R.attr.actionBarWidgetTheme, outValue, true);
