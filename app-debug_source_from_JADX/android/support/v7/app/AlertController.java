...
class AlertController {
    ...
    private final OnClickListener mButtonHandler = new C02271();
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController dialog) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                ListAdapter c02322 = new CursorAdapter(this.mContext, this.mCursor, false) {
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0241R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0241R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0241R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0241R.attr.alertDialogCenterButtons, outValue, true);
        if (outValue.data != 0) {
            return true;
        }
        return false;
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0241R.styleable.AlertDialog, C0241R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0241R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0241R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0241R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0241R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0241R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0241R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0241R.styleable.AlertDialog_showTitle, true);
        a.recycle();
    ...
    private void setupView() {
        View spacer;
        View parentPanel = this.mWindow.findViewById(C0241R.id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0241R.id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0241R.id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0241R.id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0241R.id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0241R.id.topPanel);
        View customContentPanel = customPanel.findViewById(C0241R.id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0241R.id.buttonPanel);
        ...
        if (!(hasButtonPanel || contentPanel == null)) {
            spacer = contentPanel.findViewById(C0241R.id.textSpacerNoButtons);
            if (spacer != null) {
        ...
        if (hasTopPanel) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                divider = topPanel.findViewById(C0241R.id.titleDividerNoCustom);
            }
            if (divider != null) {
                divider.setVisibility(0);
            }
        } else if (contentPanel != null) {
            spacer = contentPanel.findViewById(C0241R.id.textSpacerNoTitle);
            if (spacer != null) {
                spacer.setVisibility(0);
            }
        }
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0241R.id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0241R.id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0241R.id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0241R.id.title_template).setVisibility(8);
            return;
        }
        ...
        if (hasTextTitle && this.mShowTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0241R.id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0241R.id.scrollView);
